...
var CropImage = /** @class */ (function (_super) {
    ...
    CropImage.getDerivedStateFromProps = function (nextProps) {
     ...
     * @param pixelCrop
     */
    CropImage.prototype.makeClientCrop = function (crop, pixelCrop) {
     ...
     * 根据入参，生成图片，用于预览小图
     */
    CropImage.prototype.getCroppedImg = function (image, pixelCrop, targetImage, mimeType) {
